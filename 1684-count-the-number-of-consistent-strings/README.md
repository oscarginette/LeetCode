...
<pre style="position: relative;"><strong>Input:</strong> allowed = "ab", words = ["ad","bd","aaab","baa","badab"]
...
<pre style="position: relative;"><strong>Input:</strong> allowed = "abc", words = ["a","b","c","ab","ac","bc","abc"]
...
<pre style="position: relative;"><strong>Input:</strong> allowed = "cad", words = ["cc","acd","b","ba","bac","bad","ac","d"]
